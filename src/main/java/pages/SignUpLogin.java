...
public class SignUpLogin extends Form {
    ...
    private final JsonFileReader testDataReader = new JsonFileReader("src/main/resources/test-data.json");
    public SignUpLogin() {
    ...
    public void putSignUpCredentials(){
        final String name = testDataReader.getValue("/signUp-credentials/username");
        final String email = testDataReader.getValue("/signUp-credentials/email");
